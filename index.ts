...
const server = Bun.serve({ // a functions that create a server and return the server object
     port: 3000,
     fetch(req) { // it is a function that will be called when a request is made to the server 
